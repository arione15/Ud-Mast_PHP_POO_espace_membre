...
if (isset($_GET['supprimer'])) {
    $manager->supprimerUtilisateur((int) $_GET['supprimer']);
...
if (isset($_POST['nom'])) {
    ...
    if($utilisateur -> isUserValid()) {
        $manager -> mettreAJourUtilisateur($utilisateur);
            ...
            <div class="col-md-6">
                <form action="administration.php" method="post" col-md-6>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" value="<?php if (isset($utilisateur)) echo $utilisateur->getNom(); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="prenom" name="prenom" value="<?php if (isset($utilisateur)) echo $utilisateur->getPrenom(); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="tel" class="form-label">Téléphone</label>
                        <input type="tel" class="form-control" id="tel" name="tel" value="<?php if (isset($utilisateur)) echo $utilisateur->getTel(); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?php if (isset($utilisateur)) echo $utilisateur->getEmail(); ?>">
                    </div>
                    ...
                    <tbody>
                        <?php foreach ($manager->getListeUtilisateurs() as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key->getTel() ?></td>
                                <td><?= $key->getEmail() ?></td>
                                <td><a href="?modifier=<?= $key->getId() ?>" class='btn btn-primary m-1'>Modifier</a><a href="?supprimer=<?= $key->getId() ?>" class='btn btn-danger m-1'>Supprimer</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
