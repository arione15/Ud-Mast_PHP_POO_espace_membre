...
if (isset($_POST['nom'])) {
    ...
    if($utilisateur -> isUserValid()) {
        ...
        $message -> 'L'utilisateur à getUtilisateur($_GET['modifier']);
            ...
            <div class="col-md-6">
                <form action="administration.php" method="post" col-md-6>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" value="<?php if (isset($utilisateur)) echo $utilisateur->getNom(); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="prenom" value="<?php if (isset($utilisateur)) echo $utilisateur->getPrenom(); ?>">
                    </div>

                    <div class="mb-3">
                        <label for="tel" class="form-label">Téléphone</label>
                        <input type="tel" class="form-control" id="tel" value="<?php if (isset($utilisateur)) echo $utilisateur->getTel(); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" value="<?php if (isset($utilisateur)) echo $utilisateur->getEmail(); ?>">
                    </div>
